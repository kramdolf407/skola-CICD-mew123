public class Questions {
    ...
    String[] q7 = {"Which one represents a single line comment in Java","//comment","//*comment","@comment","#comment"};
    String[] q8 = {"Which one represents a multi line comment in Java","//comment","/*comment*/","@comment","#comment"};
